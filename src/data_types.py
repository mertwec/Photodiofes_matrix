...
class Frame:
    ...
    angle_x: float | None = None  # угол отклонения центра по x, град (FOC + радиус) расчетное
    angle_y: float | None = None  # угол отклонения центра по y, град (FOC + радиус) рассчетное
