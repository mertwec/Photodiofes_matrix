...
class Frame:
    ...
    lost: bool = False  # потеря позиции (nz < NZ_ANGLE_MIN, Задача №8): точка у края дисплея, жёлтая, углы — последний измеренный (жёлтым) или прочерк, если измерений ещё не было
